...
AJAX = {
    ...
    alertbtc:function(flag){
        ...
        warinhtml += '<a class="ui-dialog-closebutton" onclick="lcookie()">×</a>';
        warinhtml += '</div>';
        ...
        warintwo += '<a class="ui-dialog-closebutton" href="javascript:hideDialog(\'tz-dialog2\');">×</a>';
        warintwo += '</div>';
        ...
        warinthree += '<a class="ui-dialog-closebutton" href="javascript:hideDialog(\'tz-dialog3\');">×</a>';
        warinthree += '</div>';
    ...
    hongbao: function(){
        $.post("/rotate/draw/rid/6", function(d){
            if(d.status){
                ...
                '<div class="wawaclose" onclick="gg()">×</div>'+
