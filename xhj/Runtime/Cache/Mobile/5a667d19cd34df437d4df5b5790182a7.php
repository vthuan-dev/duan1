...
<head>
	...
	<style>
        ...
        .listbox{width:100%;height:100px;background:#fff;padding:5px 15px;}
        ...
        .listbox{width:100%;background:#fff;margin-top:120px;}
        .tlistbox{width:100%;clear:both;padding:10px 0px;}
	    .tlistbox_1{width:100%;border-bottom:1px solid #f5f5f5;}
	...
	<div class="container-fluid " style="padding:0px;width:100vw;">
		...
		<div class="contentbox">
		    <div class="contentbox_top" style="position: fixed;top: 50px;background:#f5f5f5;">
		        <div class="titlebox">
		            <span class="xztitile" id="wtlistbtn"><?php echo L('全部认购');?></span>
		        </div>
		        <div class="titlebox">
		            <span class="notitile" id="alllistbtn"><?php echo L('冻结中');?></span>
		        </div>
		        <div class="titlebox">
		            <span class="notitile" id="finishbtn"><?php echo L('已解冻');?></span>
		        </div>
		    </div>
		    
		    <!---已解冻-->
		    <div class="listbox" id="finishbox" style="display:none;">
		        <?php if(empty($jdllist)): ?><div class="emptybox">
		            <span class="fcc fzmm"><?php echo L('暂时没有记录');?></span>
		        </div>
		        <?php else: ?>
		        <?php if(is_array($jdllist)): foreach($jdllist as $key=>$vo): ?><div class="tlistbox">
		            <div class="tlistbox_1">
		                <div class="tlistbox_2">
		                    <div class="tlistbox_3 fl">
		                        <span class="fzmmm fch" style="font-weight:500;"><?php echo L('项目');?>：<?php echo ($vo["name"]); ?></span>
		                    </div>
		                    <?php if($vo["status"] == 1): ?><div class="tlistbox_4 fr tr">
		                        <span class="tlistbox_5 red"><?php echo L('冻结中');?></span>
		                    </div>
		                    <?php elseif($vo["status"] == 2): ?>
		                    <div class="tlistbox_4 fr tr">
		                        <span class="tlistbox_5 green"><?php echo L('已解冻');?></span>
		                    </div><?php endif; ?>
		                </div>
		                
		                
		                <div class="tlistbox_6">
		                    <div class="tlistbox_7 fl" style="width:30%;height:60px;">
		                        <div class="tlistbox_8 tl">
		                            <span class="fzm fcc"><?php echo L('认购数量');?>(<?php echo strtoupper($vo['coinname']);?>)</span>
		                        </div>
		                        <div class="tlistbox_9 tl">
		                            <span class="fzmm fch"><?php echo ($vo["num"]); ?></span>
		                        </div>
		                    </div>

		                    <div class="tlistbox_7 fl" style="width:40%;height:60px;">
		                        <div class="tlistbox_8 tc">
		                            <span class="fzm fcc"><?php echo L('支付金额');?>(<?php echo strtoupper($vo['buycoin']);?>)</span>
		                        </div>
		                        <div class="tlistbox_9 tc">
		                            <span class="fzmm fch"><?php echo ($vo["mum"]); ?></span>
		                        </div>
		                    </div>
		                    ...
		                    <div class="tlistbox_7 fl" style="width:30%;height:60px;">
		                        <div class="tlistbox_8 tr">
		                            <span class="fzm fcc"><?php echo L('解冻日期');?></span>
		                        </div>
		                        <div class="tlistbox_9 tr">
		                            <span class="fzmm fch"><?php echo ($vo["endday"]); ?></span>
		                        </div>
		                    </div>
		                </div>
		    ...
		    <div class="listbox" id="alllistbox"  style="display:none;">
		        <?php if(empty($djllist)): ?><div class="emptybox">
		            <span class="fcc fzmm"><?php echo L('暂时没有记录');?></span>
		        </div>
		        <?php else: ?>
		        <?php if(is_array($djllist)): foreach($djllist as $key=>$vo): ?><div class="tlistbox">
		            <div class="tlistbox_1">
		                <div class="tlistbox_2">
		                    <div class="tlistbox_3 fl">
		                        <span class="fzmmm fch" style="font-weight:500;"><?php echo L('项目');?>：<?php echo ($vo["name"]); ?></span>
		                ...
		                <div class="tlistbox_6">
		                    <div class="tlistbox_7 fl" style="width:30%;">
		                        <div class="tlistbox_8 tl">
		                            <span class="fzm fcc"><?php echo L('认购数量');?>(<?php echo strtoupper($vo['coinname']);?>)</span>
		                        </div>
		                        <div class="tlistbox_9 tl">
		                    ...
		                    <div class="tlistbox_7 fl" style="width:40%;">
		                        <div class="tlistbox_8 tc">
		                            <span class="fzm fcc"><?php echo L('支付金额');?>(<?php echo strtoupper($vo['buycoin']);?>)</span>
		                        </div>
		                        <div class="tlistbox_9 tc">
