...
<body style="background:#fff;">
	<div class="container-fluid " style="padding:0px;width:100vw;">
		...
		<div class="infobox">
		    <div class="infotbox">
		        <span class="fcy" style="font-size:24px;font-weight:bold;">-<?php echo ($info["num"]); ?> USDT</span>
		    </div>
		    <div class="lbox">
		        <div class="lbox_l">
		        ...
		        <div class="lbox_r">
		            <span class="fch fzmm"><?php echo L('普通提币');?></span>
		        </div>
		    </div>
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fcc fzmm"><?php echo L('手续费');?></span>
		        </div>
		        <div class="lbox_r">
		            <span class="fch fzmm"><?php echo ($info["fee"]); ?></span>
		        </div>
		    </div>
		    
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fcc fzmm"><?php echo L('实际到账');?></span>
		        </div>
		        <div class="lbox_r">
		            <span class="fch fzmm"><?php echo ($info["mum"]); ?></span>
		        </div>
		    </div>
		    
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fcc fzmm"><?php echo L('提币地址');?></span>
		        </div>
		        <div class="lbox_r" style="overflow: hidden;text-overflow:ellipsis;white-space: nowrap;">
		            <span class="fch fzmm"><?php echo ($info["address"]); ?></span>
		        </div>
		    </div>
