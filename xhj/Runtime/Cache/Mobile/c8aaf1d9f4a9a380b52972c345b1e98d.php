        ...
        <div class="dela-presets-container-2" style="padding: 0px;">
            <div class="dela-preset-container">
                <form class="dela-preset-2-2" onclick="return false" method="get">
                    ...
                    <input type="text" name="invite" id="invit"  placeholder="Invite Code" required="" value="<?php echo ($qrcode); ?>">
                    <div>
                        <input type="text" id="ecode" name="code" placeholder="Code"  class="code"  required=""  value="">
                        <button  class="btn-hover color-4 send-btn" onclick="getCode()"> Send </button>
                    </div>
                    <input type="submit" name="submit"  onclick="upreg()" value="Registration">
                    <input type="submit" name="submit" onclick="uplogin()" value="Login">
