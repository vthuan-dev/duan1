        ...
        <div class="dela-presets-container-2" style="padding: 0px;">
            <div class="dela-preset-container">
                <form class="dela-preset-2-2" onclick="return false" method="get">
                    <p class="dela-form__title"><?php echo L('修改密码');?></p>
                    ...
                    <input type="password" name="password" id="pass-2" placeholder="New Password" required="">
                    ...
                    <input type="submit" name="submit"  onclick="upreg()" value="<?php echo L('提交');?>">
