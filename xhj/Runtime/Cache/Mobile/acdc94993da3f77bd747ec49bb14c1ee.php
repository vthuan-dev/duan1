...
<div class="container-fluid ctbox">
    ...
    <div class="no_content">
        ...
        <div class="no_title" style="background: rgb(245, 245, 245);padding-left:15px;">
            <span class="title_txt fch"><?php echo L('修改密码');?></span>
        </div>
        ...
        <div class="no_inbox">
            ...
            <a href="<?php echo U('Index/respwd');?>">
                <div class="lbox">
                    <div class="lbox_l">
                        <span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('修改登陆密码');?></span>
                    </div>
                    <div class="lbox_r">
            ...
            <a href="<?php echo U('Index/withdrawpwd');?>">
                <div class="lbox">
                    <div class="lbox_l">
                        <span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('提现密码');?></span>
                    </div>
                    <div class="lbox_r">
                        <i class="bi bi-chevron-right fcc fw" style="font-size: 22px;"></i>
                    </div>
