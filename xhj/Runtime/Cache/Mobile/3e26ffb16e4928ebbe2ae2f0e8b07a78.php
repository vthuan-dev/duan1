...
<head>
	...
	<style>
	    ...
	    .infotbox{width:100%;border-bottom:1px solid #f5f5f5;}
...
<body style="background:#fff;">
	<div class="container-fluid " style="padding:0px;width:100vw;">
		...
		<div class="infobox">
		    <div class="infotbox">
		        <span class="fcy" style="font-size:20px;font-weight:bold;"><?php echo ($info["title"]); ?></span>
		    </div>
		    <noempty name="$info.img">
		    <div class="lboxc">
		    ...
		    <div class="lbox">
		        <div class="lbox_l">
		            <span class="fcc fzmm"><?php echo L('发布时间');?></span>
		        </div>
		        <div class="lbox_r">
