...
<head>
	...
	<style>
	    ...
	    .contentbox_line{width:100%;height:50px;background:#fff;padding: 0px 15px;}
	    ...
	    .imgbox_3{width:100px;height:30px;line-height:30px;text-align:center;border:1px solid #FCD535;border-radius:5px;}
	    .tx_inputbox{width:100%;height:40px;background:#f5f5f5;border-radius:5px;padding:0px 10px;}
...
<body>
	<div class="container-fluid " style="padding:0px;width:100vw;">
		...
		<div class="contentbox">
		    <div class="contentbox_top" style="padding: 0px 15px;">
		        <span style="font-size:26px;font-weight:500;"><?php echo L('添加提币地址');?></span>
		    </div>
		    ...
		    <div style="width:100%;height:500px;background:#fff;margin-top:10px;padding:5px 15px;">
		        <div class="imgbox_1">
		        ...
		        <div class="tx_inputbox">
		            <div class="tx_inputbox_l">
		                <input type="text" id="address" name="address" placeholder="<?php echo L('输入或长按粘贴地址');?>" style="background:#f5f5f5;border:1px solid #f5f5f5;width: 100%;" />
		            </div>
		        </div>
		        
		        <div class="imgbox_1" style="margin-top:10px;">
		            <span class="fzmmm fch"><?php echo L('备注');?></span>
		        </div>
		        
		        <div class="tx_inputbox">
		            <div class="tx_inputbox_l">
		                <input type="text" id="remark" name="remark" placeholder="<?php echo L('请输入备注');?>" style="background:#f5f5f5;border:1px solid #f5f5f5;width: 100%;" />
		            </div>
		        </div>
		...
		<div class="btnbox">
		    <div class="btnaddress">
		        <span class="fzmm fch"><?php echo L('保存');?></span>
		    </div>
		</div>
