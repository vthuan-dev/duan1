	...
	<div class="container-fluid " style="padding:0px;width:100vw;">
		...
		<div class="contentbox">
		    <div class="contentbox_top" style="position: fixed;top: 50px;background: #f5f5f5;">
		        <span style="font-size:26px;font-weight:500;"><?php echo L('提币记录');?></span>
		    </div>
		    <div style="width:100%;min-height:65vh;background:#fff;margin-top:100px;">
		        ...
		        <?php if(empty($txlist)): ?><div class="listbox" style="border:none;">
		            <div style="width:100%;height:100px;line-height:100px;text-align:center;">
		                <span class="fzm fcc"><?php echo L('暂时没有提币记录');?></span>
		            </div>
		        </div>    
		        <?php else: ?>
		        <?php if(is_array($txlist)): foreach($txlist as $key=>$vo): ?><a href="<?php echo U('User/txinfo');?>?oid=<?php echo ($vo["id"]); ?>">
		        <div class="listbox">
                    <div class="listbox_title">
                        <div class="listbox_title_l">
                            <span class="fcc" style="font-size:18px;font-weight:500;"><?php echo strtoupper($vo['coinname']);?></span>
                        </div>
                    ...
                    <div style="width:100%;height:60px;">
                        ...
                        <div style="width:33.33%;height:60px;float:left;">
                            ...
                            <div style="width:100%;height:30px;line-height:30px;">
                                <span class="fch"><?php echo ($vo["fee"]); ?></span>
                            </div>
                        </div>
                        <div style="width:33.33%;height:60px;float:left;">
