	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b" style="background:#fff;">
	                        ...
	                        <a data-bn-type="link" href="<?php echo U('Orepool/normalmin');?>" class="css-6ijtmk" style="background:#f5f5f5;">
	                            <div class="css-10j588g">
	                   ...
	                   <div class="css-1wr4jig" style="background:#fff;">
	                       <div class="css-6ul7zn">
	                           <div class="css-joa6mv">
	                               <div data-bn-type="text" class="css-1868gi1"><?php echo L('我的矿机');?></div>
	                           </div>
	                                       ...
	                                       <div class="minbox">
	                                           ...
	                                           <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="minlist">
	                                               ...
	                                               <div style="width:40%;height:120px;float:left;">
	                                                   ...
	                                                   <p class="f14" style="margin: 5px;"><span style="background:#0ecb81;padding:5px 10px;border-radius: 5px;color:#fff;"><?php echo L('正常');?></span></p>
	                                               </div>
