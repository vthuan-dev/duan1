                                            ...
                                            <div class="coinbox">
                                                ...
                                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="coincontent">
                                                    <div class="contentop" style="width:15%;">
                                                        <span class="f14 fch fw"><?php echo strtoupper($vo['title']);?></span>
                                                    </div>
                                                    <div class="contentop" style="width:15%;">
                                                    ...
                                                    <div class="contentop" style="width:40%;">
                                                        <a href="<?php echo U('Finance/czpage');?>?id=<?php echo ($vo["id"]); ?>" class="f14 fcy"><?php echo L('充币');?></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="<?php echo U('Finance/txpage');?>?id=<?php echo ($vo["id"]); ?>" class="f14 fcy"><?php echo L('提币');?></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                    </div>
