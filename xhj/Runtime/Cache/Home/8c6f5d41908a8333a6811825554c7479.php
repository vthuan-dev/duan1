	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b" style="background:#fff;">
	                        ...
	                        <a data-bn-type="link" href="<?php echo U('Issue/normalissue');?>" class="css-6ijtmk" style="background:#f5f5f5;">
	                            <div class="css-10j588g">
	                   ...
	                   <div class="css-1wr4jig" style="background:#fff;">
	                       <div class="css-6ul7zn">
	                           <div class="css-joa6mv">
	                               <div data-bn-type="text" class="css-1868gi1"><?php echo L('认购记录');?><span class="fcy f14">(<?php echo L('冻结中');?>)</span></div>
	                           </div>
