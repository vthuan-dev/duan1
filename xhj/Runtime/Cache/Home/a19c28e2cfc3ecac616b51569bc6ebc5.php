	                   ...
	                   <div class="css-1wr4jig" style="background:#fff;">
	                       <div class="css-6ul7zn">
	                           <div class="css-joa6mv">
	                               <div data-bn-type="text" class="css-1868gi1"><?php echo L('全部委托');?></div>
	                           </div>
	                           <div class="css-1h690ep">
	                               <div class="css-jjjwcg">
	                                   <div class="css-15owl46">
	                                       <div class="btitle">
	                                           <div class="btitleop" style="width:6%;">
	                                               <span class="fch f14">ID</span>
	                                           </div>
	                                           <div class="btitleop" style="width:9%;">
	                                           ...
	                                           <div class="btitleop" style="width:20%;">
	                                               <span class="fch f14"><?php echo L('委托时间');?></span>
	                                           </div>
	                                           <div class="btitleop" style="width:15%;">
	                                               <span class="fch f14"><?php echo L('操作');?></span>
	                                           </div>
	                                       </div>
	                                       <div style="width:100%;height:400px;overflow: auto;">
	                                           ...
	                                           <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div style="width:100%;height:60px;background:#fff;border-bottom:1px solid #f5f5f5;">
	                                                <div class="bcontentop" style="width:6%;">
	                                                    <span class="fch f14"><?php echo ($vo["id"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:9%;">
	                                                    <span class="fch f14"><?php echo ($vo["symbol"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:10%;">
	                                                    <?php if($vo["type"] == 1): ?><span class="f14 fw fgreen"><?php echo L('购买');?></span>
		                                                <?php elseif($vo["type"] == 2): ?>
		                                                <span class="f14 fw fred"><?php echo L('出售');?></span><?php endif; ?>
	
	                                                </div>
	                                                <div class="bcontentop" style="width:10%">
	                                                    <?php if($vo["status"] == 1): ?><span class="fch f14"><?php echo L('委托中');?></span>
	                                                    <?php elseif($vo["status"] == 2): ?>
	                                                    <span class="fch f14"><?php echo L('交易完成');?></span>
	                                                    <?php elseif($vo["status"] == 3): ?>
	                                                    <span class="fch f14"><?php echo L('已撤消');?></span><?php endif; ?>
	                                                </div>
	                                                <div class="bcontentop" style="width:15%;">
	                                                    <?php if($vo["type"] == 1): ?><span class="fch f14"><?php echo ($vo["usdtnum"]); ?></span>
	                                                    <?php elseif($vo["type"] == 2): ?>
	                                                    <span class="fch f14"><?php echo ($vo["coinnum"]); ?></span><?php endif; ?>
	                                                </div>
	                                                <div class="bcontentop" style="width:15%;">
	                                                    <span class="fch f14"><?php echo ($vo["xjprice"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:20%;">
	                                                    <span class="fch f14"><?php echo ($vo["addtime"]); ?></span>
	                                                </div>
	                                                <div class="bcontentop" style="width:15%;">
	                                                    <span class="fcy f14" onclick="clearorder(<?php echo ($vo["id"]); ?>);" style="background:#f5f5f5;padding:5px 10px;border-radius:5px;cursor: pointer;"><?php echo L('撤消委托');?></span>
	                                                </div>
