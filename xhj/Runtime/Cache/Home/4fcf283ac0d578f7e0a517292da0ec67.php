...
<html lang="zh-CN">
    <head>
        ...
        <style>
            ...
            .minbox{width:100%;height:400px;overflow: auto;}
            .minlist{width:100%;height:120px;background:#fff;box-shadow: 0 2px 10px 0 rgb(0 0 0 / 10%);margin-bottom:15px;}
	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b" style="background:#fff;">
	                        ...
	                        <a data-bn-type="link" href="<?php echo U('Orepool/overduemin');?>" class="css-6ijtmk" style="background:#f5f5f5;">
	                            <div class="css-10j588g">
	                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="icon" class="css-hd27fe" style="color:#00b897;fill: #00b897;">
	                                    <path d="M3.7 15.3c.1.1.1.3.2.4-.1-.1-.2-.2-.2-.4z" fill="icon"></path><path d="M20.4 11.8c0 4.8-3.9 8.8-8.8 8.8-3.1 0-6-1.7-7.6-4.4-.1-.2-.2-.3-.3-.5.1-.1 0-.2 0-.4-.2-.4-.3-.8-.4-1.2l1.9-.5.3.9c.1.2.2.4.2.5 1.1 2.2 3.4 3.6 6 3.6 3.7 0 6.8-3 6.8-6.8 0-3.7-3-6.8-6.8-6.8V3c4.8.1 8.7 4 8.7 8.8zM3 11.9c0-.8.1-1.5.3-2.3l1.9.5c-.1.6-.2 1.1-.2 1.7l-2 .1zM5.8 8.5l-1.7-1c.4-.7.8-1.3 1.4-1.8l1.4 1.4c-.4.4-.8.9-1.1 1.4zM8.3 6l-1-1.7c.7-.4 1.4-.7 2.1-.9l.5 1.9c-.5.2-1.1.4-1.6.7z" fill="icon"></path><path d="M11 17.5v-1.2c-1.3-.1-2.2-.6-2.8-1.3l1.2-1.1c.5.5 1.1.9 1.8 1v-2.3c-1.9-.4-2.7-1.2-2.7-2.5s.9-2.2 2.5-2.4V6.4h1.5v1.2c1 .1 1.8.5 2.3 1.2l-1.1 1c-.3-.3-.7-.6-1.3-.8v2.1c1.8.4 2.7 1.1 2.7 2.5 0 1.3-.8 2.3-2.5 2.6v1.2H11v.1zm.2-6.6V9c-.7.1-.9.5-.9 1s.3.8.9.9zm1.1 1.9v2c.6-.2.9-.6.9-1.1 0-.3-.1-.7-.9-.9z" fill="icon"></path></svg>
	                   ...
	                   <div class="css-1wr4jig" style="background:#fff;">
	                       <div class="css-6ul7zn">
	                           <div class="css-joa6mv">
	                               <div data-bn-type="text" class="css-1868gi1"><?php echo L('过期矿机');?></div>
	                           </div>
	                           ...
	                           <div class="css-1h690ep">
	                               <div class="css-jjjwcg">
	                                   <div class="css-15owl46">
	                                       <div class="minbox">
	                                           <?php if(empty($list)): ?><div style="width:100%;height:300px;line-height:300px;text-align:center;">
	                                           ...
	                                           <?php else: ?>
	                                           <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="minlist">
	                                               <div style="width:20%;height:120px;float:left;">
	                                                   <div style="width:100%;height:120px;text-align:center;">
	                                                       <img src="/Upload/public/<?php echo ($vo["imgs"]); ?>" style="height:80px;margin-top: 20px;" />
	                                                   </div>
	                                               </div>
	                                               <div style="width:40%;height:120px;float:left;">
	                                                   <p class="f14" style="margin: 8px 5px 5px 5px;;"><?php echo L('矿机名称');?>：<?php echo ($vo["kjtitle"]); ?></p>
	                                                   <p class="f14" style="margin: 5px;"><?php echo L('矿机类型');?>：
	                                                   <?php if($vo["type"] == 1): ?><span class="fgreen"><?php echo L('独资机型');?>，<?php echo L('所有权');?>：100%</span>
	                                                   <?php elseif($vo["type"] == 2): ?>
	                                                   <span class="fred"><?php echo L('共享机型');?>，<?php echo L('所有权');?>：<?php echo ($vo["sharebl"]); ?>%</span><?php endif; ?>
	                                                   </p>
	                                                   <p class="f14" style="margin: 5px;"><?php echo L('购买时间');?>：<?php echo ($vo["addtime"]); ?></p>
	                                                   <p class="f14" style="margin: 5px;"><?php echo L('到期时间');?>：<?php echo ($vo["endtime"]); ?></p>
	                                                   
	                                               </div>
	                                               <div style="width:40%;height:120px;float:left;">
	                                                   <p class="f14" style="margin: 8px 5px 5px 5px;;"><?php echo L('产出币种');?>：<?php echo strtoupper($vo['outcoin']);?></p>
	                                                   <p class="f14" style="margin: 5px;"><?php echo L('产出类型');?>：
	                                                   <?php if($vo["outtype"] == 1): echo L('每天产出'); echo L('每天等值');?>：<?php echo ($vo["outusdt"]); ?> USDT
	                                                   <?php elseif($vo["outtype"] == 2): ?>
	                                                   <?php echo L('每天产出');?>：<?php echo ($vo["outnum"]); ?> <?php echo strtoupper($vo['outcoin']); endif; ?>
	                                                   <p class="f14" style="margin: 5px;"><?php echo L('矿机产权');?>：<?php echo ($vo["cycle"]); ?> <?php echo L('天');?></p>
	                                                   <p class="f14" style="margin: 5px;">
	                                                       <?php if($vo["status"] == 2): ?><span style="background:#CF304A;padding:5px 10px;border-radius: 5px;color:#fff;"><?php echo L('已过期');?></span>
	                                                       <?php elseif($vo["status"] == 2): ?>
	                                                       <span style="background:#0ecb81;padding:5px 10px;border-radius: 5px;color:#fff;"><?php echo L('正常');?></span><?php endif; ?>
	                                                   </p>
	                                               </div>
