						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									...
									<td><select name="name" class="form-control input-10x">
										<?php if(is_array($coinlist)): $i = 0; $__LIST__ = $coinlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['name']); ?>"
											<?php if(($data['name']) == $v['name']): ?>selected<?php endif; ?>
