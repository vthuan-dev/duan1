	...
	<div id="main" class="main">
		...
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('Config/marketoEdit2');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls" style="border-top:1px solid #d0d0d0;">
									...
									<td>
										<select name="shuadan" class="form-control input-10x">
											<option value="0"
											<?php if(($data["shuadan"]) == "0"): ?>selected<?php endif; ?>
											>关闭</option>
											<option value="1"
											<?php if(($data["shuadan"]) == "1"): ?>selected<?php endif; ?>
											>开启</option>
										</select>
									</td>
									<td class="item-note"></td>
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="sdhigh" value="<?php echo ($data["sdhigh"]); ?>">
									</td>
								</tr>
								<tr class="controls">
									<td class="item-label">浮动最低价格:</td>
									<td>
										<input type="text" class="form-control input-10x" name="sdlow" value="<?php echo ($data["sdlow"]); ?>">
									</td>
								</tr>
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="sdhigh_num" value="<?php echo ($data["sdhigh_num"]); ?>" oninput="if(value<<?php echo ($round); ?>)value=<?php echo ($round); ?>">
									</td>
								</tr>
								<tr class="controls">
									<td class="item-label">浮动最低数量:</td>
									<td>
										<input type="text" class="form-control input-10x" name="sdlow_num" value="<?php echo ($data["sdlow_num"]); ?>" oninput="if(value<<?php echo ($round); ?>)value=<?php echo ($round); ?>">
									</td>
								</tr>
