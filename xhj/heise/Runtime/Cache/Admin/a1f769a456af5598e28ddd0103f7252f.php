        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if(($vo["shuadan"]) == "1"): ?><b style="color: #028E16;">已开启</b><?php else: ?>未启动<?php endif; ?>
                            </td>
                            <td>
                                <?php if(($vo["trade"]) == "1"): ?><b style="color: #028E16;">开启交易</b><?php else: ?>禁止交易<?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td style="text-align: center;">
                                <?php if(($vo["name"]) != "cny"): ?><a href="<?php echo U('Trade/marketEdit?id='.$vo['id']);?>" class="btn btn-primary btn-xs">编辑</a>
                                    <a onClick="javascript:if(!confirm('此操作会清理价格不在刷单价格区间的未成交刷单订单(不包含用户订单),确认吗？'))  return  false; "   href="<?php echo U('Trade/tradeclear?type=2&id='.$vo['id']);?>" class="btn btn-info btn-xs">清理刷单(部分)</a>
                                    <a onClick="javascript:if(!confirm('此操作会清理所有未成交刷单订单(不包含用户订单),确认吗？'))  return  false; " href="<?php echo U('Trade/tradeclear?type=1&id='.$vo['id']);?>" class="btn btn-info btn-xs">清理刷单(全部)</a><?php endif; ?>
                            </td>
