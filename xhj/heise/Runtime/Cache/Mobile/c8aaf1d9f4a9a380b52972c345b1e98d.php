        ...
        <div class="dela-presets-container-2" style="padding: 0px;">
            <div class="dela-preset-container">
                <form class="dela-preset-2-2" onclick="return false" method="get">
                    ...
                    <input type="email" name="email" id="email" placeholder="E-mail" required="" autocomplete="email" style="display: none">
                    ...
                    <input type="text" name="invite"  placeholder="Invite Code" required="" autocomplete="invite">
                    <div>
                    <input type="text" name="code" placeholder="Code"  class="code"  required="" >
                    <button class="btn-hover color-4 send-btn"> Send </button>
                    </div>
