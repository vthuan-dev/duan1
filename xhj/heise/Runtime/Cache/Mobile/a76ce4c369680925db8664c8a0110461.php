	...
	<div class="optionbox" style="margin-top:0px;">
		<div style="width:100%;height:80px;">
			...
			<div class="oplist">
				...
				<div class="optext">
					<span class="fzmm fcc"><?php echo L('充币');?></span>
				</div>
			</div>
			</a>
			...
			<div class="oplist">
				...
				<div class="optext">
					<span class="fzmm fcc"><?php echo L('提币');?></span>
				</div>
			</div>
			</a>
			...
			<div class="oplist">
				...
				<div class="optext">
					<span class="fzmm fcc"><?php echo L('认购');?></span>
				</div>
			</div>
			</a>
			...
			<div class="oplist">
				...
				<div class="optext">
					<span class="fzmm fcc"><?php echo L('挖矿');?></span>
				</div>
			</div>
			</a>
			...
			<div class="oplist">
				...
				<div class="optext">
					<span class="fzmm fcc"><?php echo L('客服');?></span>
				</div>
			</div>
			</a>
