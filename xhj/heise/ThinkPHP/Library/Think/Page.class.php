...
class Page
{
	...
	{
        $this->config  =    array('header'=>L('条记录'),'prev'=>L('上一页'),'next'=>L('下一页'),'first'=>L('第一页'),'last'=>L('最后一页'),'theme'=>' %totalRow% %header% %nowPage%/%totalPage% '.L('页').' %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
